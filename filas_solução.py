...
'''
Inverter a fila (acrescentando uma nova função na classe original)
'''
...
'''
Remover o elemento de maior valor (seja numérico ou caractere) ​
...
'''
Remover o elemento de meno valor (seja numérico ou caractere) ​
...
'''
Organizar a fila de forma crescente (prioridade por idade)​
acrescentando uma nova função na classe original.
'''
